...
from lib.config.default import update_config, cfg
...
def main():
    ...
    if rank in [-1, 0]:
        ...
        if cfg.TRAIN.SEG_ONLY:  #Only train two segmentation branch
        ...
        if cfg.TRAIN.ENC_SEG_ONLY:  # Only train encoder and two segmentation branch
        ...
        if cfg.TRAIN.ENC_DET_ONLY or cfg.TRAIN.DET_ONLY:    # Only train encoder and detection branch
    ...
    for epoch in range(begin_epoch+1, cfg.TRAIN.END_EPOCH+1):
        ...
        if (epoch > cfg.TRAIN.VAL_START and (epoch % cfg.TRAIN.VAL_FREQ == 0 or epoch == cfg.TRAIN.END_EPOCH)) and rank in [-1, 0]:
            # print('validate')
