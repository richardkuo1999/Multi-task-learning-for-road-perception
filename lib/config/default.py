...
_C.DATASET.DATAROOT = 'F:/dataset/BDD100k_10k/bdd100k_images_10k/bdd100k/images/10k'       # the path of images folder
_C.DATASET.LABELROOT = 'F:/dataset/BDD100k_10k/labels/10k'         # the path of det_annotations folder
_C.DATASET.MASKROOT = 'F:/dataset/BDD100k_10k/labels/bdd_seg_gt'    # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = 'F:/dataset/BDD100k_10k/labels/bdd_lane_gt'   # the path of ll_seg_annotations folder
...
_C.TRAIN.VAL_FREQ = 5
_C.TRAIN.VAL_START = 5
_C.TRAIN.BATCH_SIZE_PER_GPU = 11
